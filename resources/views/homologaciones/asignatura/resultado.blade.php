...
<head>
    ...
    <style>
        table { border-collapse: collapse; font-family: Roboto, Arial, sans-serif; font-size: 12px; width: 100%; }
        .sombra { background-color: #ccc; }
        .sinborde { border: none; text-align: center; font-size: 10px; }
        body { margin: 20px; }
        input, textarea { font-family: inherit; }
        .saiq-ciclo-page { page-break-before: always; margin-top: 30px; }
    </style>
</head>
<body>
@php
...
@if(!empty($cicloUniversitario))
    <div class="saiq-ciclo-page">
        @include('homologaciones.asignatura._documento', $cicloUniversitario)
    </div>
@endif
</body>
</html>
